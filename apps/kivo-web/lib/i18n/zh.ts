...
export const zh: Dictionary = {
  ...
  login: {
    ...
    checkEmail: "查收您的邮件",
    sentCode: "我们发送了一个4位验证码至",
    verifyCode: "验证验证码",
    back: "返回",
    invalidCode: "验证码无效",
    failedSendCode: "验证码发送失败",
    welcomeBack: "欢迎回来！",
    devLogin: "快速开发登录",
  },
  signup: {
  ...
  agentPage: {
    ...
    historyBtn: "对话历史",
    channelsTitle: "通信渠道",
    channelsDesc: "将智能体连接至即时通信平台，使用户能直接与其交互。",
    comingSoon: "即将推出",
    ...
    editor: {
      titleSuffix: "内容",
      readOnly: "只读",
      readingLive: "正在读取智能体磁盘...",
      noContent: "暂无内容。",
      fetchedLive: "此数据从智能体的持久存储中实时获取。",
    },
    telegramChannel: {
      botFatherGuide: "打开 Telegram，向 @BotFather 发送消息并输入 /newbot。选择显示名称和以 \"bot\" 结尾的用户名。BotFather 会回复一个 Token，请将其粘贴到下方。",
      updateTokenTitle: "更新 Bot Token",
      updateTokenDesc: "已有保存的 Token。在下方粘贴新 Token 即可替换，这将重启智能体。",
      pasteNewPlaceholder: "粘贴新 Token 以更新…",
      updateBtn: "更新",
      botTokenLabel: "Bot Token",
      botTokenPlaceholder: "在此粘贴您的机器人 Token…",
      saveConnectBtn: "保存并连接",
      saving: "保存中…",
      awaitingCodeTitle: "等待配对码",
      awaitingCodeDesc: "您的智能体正在使用新 Token 重启。准备就绪后，向 Telegram 机器人发送任意消息，它将回复配对码。",
      step1: "打开 Telegram 并向您的机器人发送任意消息",
      step2: "机器人将回复一个一次性配对码。",
      step3: "在下方粘贴配对码并点击批准。",
      pairingCodeLabel: "配对码",
      pairingCodePlaceholder: "粘贴机器人发送给您的配对码…",
      approveBtn: "批准",
      approving: "批准中…",
      wrongTokenTitle: "Token 错误？更换 Token",
      wrongTokenPlaceholder: "粘贴新 Token 以进行替换…",
    },
  },
  agentDashboard: {
    backToAgent: "返回智能体",
  ...
  teamsPage: {
    ...
    taskApproved: "任务批准成功",
    failedApproveTask: "批准任务失败",
    taskRejected: "任务已拒绝",
    failedRejectTask: "拒绝任务失败",
    anItem: "一项内容",
    activities: "动态",
    noActivities: "暂无动态。",
    createdBy: "创建者",
    ...
    activityLabels: {
      ...
      requestOpened: "请求已开启",
      requestReassignedAndRetried: "请求已重新分配并重试",
      requestInProgress: "请求处理中",
      createdNewRequest: "创建了新请求",
      taskUpdated: "任务已更新",
      taskDeleted: "任务已删除",
      you: "您",
    },
  ...
  teamSettings: {
    ...
    providerLabel: "集成提供商",
    settingsTitle: "团队设置",
    settingsSubtitle: "配置该团队的工作方式、智能体能力以及可以访问的外部工具。",
    tabs: {
      general: "通用",
      workflow: "工作流",
      integrations: "集成",
    ...
    general: {
      identityTitle: "身份标识",
      identityDesc: "团队的基本信息。",
      teamName: "团队名称",
      timezone: "时区",
      purposeTitle: "目标与实践",
      purposeDesc: "定义团队的使命和工作方式。",
      mission: "使命",
      missionPlaceholder: "该团队应该创造什么成果？",
      waysOfWorking: "工作方式",
      waysOfWorkingPlaceholder: "该团队应该如何沟通？",
      aiInsights: "AI 洞察",
      aiAssistant: "AI 助手",
      insert: "插入",
      reply: "回复...",
    ...
    workflow: {
      ...
      noCapsFound: "未找到符合条件的团队能力。",
      details: "详情",
    },
    dangerZone: {
      title: "危险区域",
      subtitle: "不可逆的操作，会影响您的团队、智能体和数据。",
      deleteTitle: "解散该团队",
      deleteDesc: "一旦解散该团队，将无法撤销。请务必确认。",
      resourcesRemovedTitle: "以下资源将被永久删除：",
      resourcesRemovedList: [
        "所有运行中的 AI 智能体容器和 Kubernetes Pods",
        "所有智能体的状态目录和持久卷声明 (PVC)",
        "所有引导 ConfigMaps 和凭据 Secrets",
        "数据库配置、任务、消息与会话历史",
      ],
      confirmPrompt: "请在下方输入 {teamName} 以确认：",
      deleteButton: "永久解散团队",
      deletingButton: "正在解散团队...",
      confirmError: "请输入准确的团队名称以确认解散。",
    }
  },
  systemSettings: {
    title: "系统设置",
    ...
    sshStatusLabel: "SSH 隧道状态",
    sshStatusDesc: "活动在端口 18789 的安全本地控制隧道。",
    connectedBadge: "已连接",
    privilegeLabel: "访问权限模型",
    privilegeDesc: "非特权本地工作沙箱编排。",
    sandboxBadge: "沙箱模式",
    systemInfoTitle: "系统信息",
    systemInfoDesc: "技术参数、配对密钥与环境规格。",
    userContextId: "用户上下文 ID",
    workspaceIdentifier: "工作区标识符",
    gatewayAddress: "网关地址",
  ...
  taskPage: {
    ...
    backToTeam: "返回团队",
    deleteTask: "删除任务",
    deleteConfirm: "您确定要删除此任务吗？此操作无法撤销。",
    taskDeleted: "任务已删除",
    failedDeleteTask: "删除任务失败",
    ...
    input: "输入",
    prompt: "Prompt",
    viewPassedInstructions: "查看已传递指令",
    passedInstructions: "已传递指令",
    execution: "执行",
    noPlanOrListNeeded: "由于任务较为简单，无需执行计划或任务列表。",
    plan: "计划",
    taskList: "任务列表",
    result: "结果",
    workSummary: "工作总结",
    success: "成功",
    failed: "失败",
    noResultYet: "尚无结果或失败原因。",
    commentsAndUpdates: "评论与动态",
    addCommentPlaceholder: "添加评论...",
    postComment: "发布评论",
    postingComment: "发布中...",
    commentPosted: "评论已发布",
    failedPostComment: "发布评论失败",
    deleteCommentConfirm: "您确定要删除此评论吗？",
