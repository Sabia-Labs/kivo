export const en = {
  ...
  agentPage: {
    ...
    channelsDesc: "Connect your agent to messaging platforms so users can interact with it directly.",
    ...
    editor: {
      titleSuffix: "Content",
      readOnly: "READ-ONLY",
      readingLive: "Reading from agent disk...",
      noContent: "No content found.",
      fetchedLive: "This data is fetched live from the agent's persistent storage.",
    },
    telegramChannel: {
      botFatherGuide: "Open Telegram, search for @BotFather and send /newbot. Choose a display name and a username ending in \"bot\". BotFather will reply with a token — paste it below.",
      updateTokenTitle: "Update Bot Token",
      updateTokenDesc: "A token is already saved. Paste a new one below to replace it. This will restart the agent.",
      pasteNewPlaceholder: "Paste new token to update…",
      updateBtn: "Update",
      botTokenLabel: "Bot Token",
      botTokenPlaceholder: "Paste your bot token here…",
      saveConnectBtn: "Save & Connect",
      saving: "Saving…",
      awaitingCodeTitle: "Awaiting Pairing Code",
      awaitingCodeDesc: "Your agent is restarting with the new Telegram token. As soon as it's ready, send any message to the bot on Telegram — it will reply with a pairing code.",
      step1: "Open Telegram and send any message to your bot",
      step2: "The bot will reply with a one-time pairing code.",
      step3: "Paste the code below and click Approve.",
      pairingCodeLabel: "Pairing Code",
      pairingCodePlaceholder: "Paste the code your bot sent you…",
      approveBtn: "Approve",
      approving: "Approving…",
      wrongTokenTitle: "Wrong token? Change it",
      wrongTokenPlaceholder: "Paste new bot token to replace…",
    },
  },
  agentDashboard: {
  ...
  teamsPage: {
    ...
    failedApproveTask: "Failed to approve task",
    taskRejected: "Task rejected",
    failedRejectTask: "Failed to reject task",
    anItem: "an item",
    ...
    activityLabels: {
      ...
      requestReassignedAndRetried: "Request reassigned and retried",
  ...
  teamSettings: {
    ...
    settingsSubtitle: "Configure how this team works, what it can do, and which external tools it can access.",
    tabs: {
      general: "General",
      workflow: "Workflow",
    ...
    general: {
      ...
      identityDesc: "Basic information about the team.",
      teamName: "Team Name",
      timezone: "Timezone",
      purposeTitle: "Purpose & Practices",
      purposeDesc: "Define the mission and ways of working for this team.",
      mission: "Mission",
      missionPlaceholder: "What outcome should this team create?",
      waysOfWorking: "Ways of Working",
      waysOfWorkingPlaceholder: "How should this team communicate?",
    ...
    workflow: {
      title: "What this team can do",
      desc: "Manage the active capabilities of your agents.",
      newCapability: "New Capability",
      filters: "Filters",
      onlyEnabled: "Only enabled capabilities",
      onlyFavorites: "Only favorites",
      searchPlaceholder: "Search capabilities...",
      noCapsFound: "No capabilities found matching your criteria.",
      details: "Details",
    },
    dangerZone: {
      title: "Danger Zone",
      subtitle: "Irreversible actions that affect your team, agents, and data.",
      deleteTitle: "Delete this team",
      deleteDesc: "Once you delete this team, there is no going back. Please be certain.",
      resourcesRemovedTitle: "The following resources will be permanently removed:",
      resourcesRemovedList: [
        "All AI agent containers and running Kubernetes pods",
        "State directories and Persistent Volume Claims (PVCs) for all agents",
        "All bootstrap ConfigMaps and credentials Secrets",
        "Database configurations, tasks, messages, and conversation history",
      ],
      confirmPrompt: "To confirm, type {teamName} below:",
      deleteButton: "Permanently Delete Team",
      deletingButton: "Deleting Team...",
      confirmError: "Please type the exact team name to confirm deletion.",
    }
  },
  systemSettings: {
    ...
    sshStatusLabel: "SSH Tunnel Status",
    sshStatusDesc: "Secure local control tunnel active on port 18789.",
    connectedBadge: "Connected",
    privilegeLabel: "Access Privilege Model",
    privilegeDesc: "Non-privileged local worker sandbox orchestration.",
  ...
  plans: {
    ...
    free: {
      name: "Free",
      subtitle: "For testing Kivo with limited capacity.",
      price: "€0/month",
      features: [
        "2 teams",
    ...
    basic: {
      name: "Basic",
      subtitle: "For individuals and small teams using Kivo seriously.",
      price: "€19/month",
      features: [
        "5 teams",
    ...
    pro: {
      name: "Pro",
      subtitle: "For teams that want full operational capacity.",
      price: "€49/month",
      features: [
        "Unlimited teams",
        "Unlimited agents",
  ...
  planBanner: {
    inactiveMessage: "Your workspace is operating with limited AI capacity.",
